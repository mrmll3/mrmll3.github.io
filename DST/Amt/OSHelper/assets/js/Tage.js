...
const form_start_date = document.getElementById("start-date");
...
const start_date = () => { return new Date(document.getElementById("start-date").value) };
const end_date = () => { return new Date(document.getElementById("end-date").value) };
